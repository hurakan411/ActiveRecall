    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("""
この利用規約（以下、「本規約」といいます）は、スマートフォン向けアプリケーション「MindRecaller」（以下、「本アプリ」といいます）の提供条件およびアプリを利用するユーザー（以下、「ユーザー」といいます）と開発者との間の権利義務関係を定めるものです。
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                Text("""
本プライバシーポリシーは、スマートフォン向け学習支援アプリケーション「MindRecaller」（以下、「本アプリ」といいます）において、ユーザーの皆様の情報をどのように取り扱うかを定めたものです。
